import { coinImage } from '../../coin-media';
...
export interface GameCharacter {
  ...
  color: string;
  svg: string;
  /** Remote coin portrait shown when unlocked. SVG used as locked silhouette. */
  imageUrl?: string;
  /** Local public asset fallback for development or failed remote loads. */
...
export const CHARACTERS: GameCharacter[] = [
  ...
  },
  {
    ...
    power: '40',
    color: '#94a3b8',
    ...coinImage('onigiri-apprentice.png'),
    svg: `${aura('#94a3b8')}
  ...
  },
  {
    ...
    power: '300',
    color: '#a16207',
    ...coinImage('tanuki-trickster.png'),
    svg: `${aura('#a16207')}
  ...
  },
  {
    ...
    power: '∞',
    color: '#f59e0b',
    ...coinImage('amaterasu-ascendant.png'),
