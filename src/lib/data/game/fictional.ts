...
export const CHARACTERS_FICTIONAL: FictionalChar[] = [
  ...
  c('impa', 'Impa', 'インパ', 'いんぱ', 'inpa', 'games', '🛡️', '#475569',
  ...
  c('link', 'Link', 'リンク', 'りんく', 'rinku', 'games', '🗡️', '#22c55e',
  ...
  c('shimon', 'Simon Belmont', 'シモン・ベルモンド', 'しもんべるもんど', 'shimon berumondo', 'games', '⛓️', '#b45309',
  ...
  c('shulk', 'Shulk', 'シュルク', 'しゅるく', 'shuruku', 'games', '🗡️', '#ef4444',
  ...
  c('majima', 'Goro Majima', '真島吾朗', 'まじまごろう', 'majima gorou', 'games', '🗡️', '#fbbf24',
  ...
  c('vergil', 'Vergil', 'バージル', 'ばーじる', 'baajiru', 'games', '🗡️', '#3b82f6',
  ...
  c('sora', 'Sora', 'ソラ', 'そら', 'sora', 'games', '🗝️', '#fbbf24',
  ...
  c('riku', 'Riku', 'リク', 'りく', 'riku', 'games', '⚔️', '#94a3b8',
  ...
  c('cloud', 'Cloud', 'クラウド', 'くらうど', 'kuraudo', 'games', '🗡️', '#fbbf24',
  ...
  c('mari', 'Mari Illustrious Makinami', '真希波・マリ・イラストリアス', 'まきなみまりいらすとりあす', 'makinami mari irasutoriasu', 'anime', '👓', '#ec4899',
    ...
    { ja: '歌', reading: 'うた', en: 'song', it: 'canzone' }),
  c('suneo', 'Suneo Honekawa', '骨川スネ夫', 'ほねかわすねお', 'honekawa suneo', 'anime', '🏙️', '#22c55e',
  ...
  c('nami', 'Nami', 'ナミ', 'なみ', 'nami', 'anime', '🗺️', '#f97316',
  ...
  c('chihiro', 'Chihiro Ogino', '千尋', 'ちひろ', 'chihiro', 'anime', '⛩️', '#f472b6',
  ...
  c('zoro', 'Roronoa Zoro', 'ロロノア・ゾロ', 'ろろのあぞろ', 'roronoa zoro', 'anime', '⚔️', '#22c55e',
  ...
  c('itachi', 'Itachi Uchiha', 'うちはイタチ', 'うちはいたち', 'uchiha itachi', 'anime', '👁️', '#ef4444',
  ...
  c('tanjiro', 'Tanjiro Kamado', '竈門炭治郎', 'かまどたんじろう', 'kamado tanjirou', 'anime', '⚔️', '#0ea5e9',
  ...
  c('luffy', 'Monkey D. Luffy', 'モンキー・D・ルフィ', 'もんきーでぃーるふぃ', 'monkii dii rufi', 'anime', '🏴‍☠️', '#ef4444',
  ...
  c('levi', 'Levi Ackerman', 'リヴァイ', 'りゔぁい', 'rivai', 'anime', '⚔️', '#475569',
  ...
  c('eren', 'Eren Yeager', 'エレン・イェーガー', 'えれんいえーがー', 'eren yeegaa', 'anime', '🗝️', '#b45309',
