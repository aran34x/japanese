// Full hiragana & katakana tables generated from romaji mappings.
// Includes gojūon (base), dakuten/handakuten (゛゜), and yōon (combos).
...
// Base gojūon + dakuten/handakuten
const base: KanaRow[] = [
  ...
  { romaji: 'di', hira: 'ぢ', kata: 'ヂ' },
  { romaji: 'du', hira: 'づ', kata: 'ヅ' },
...
// Yōon (combination) syllables
const combos: KanaRow[] = [
...
export const kanaTable: KanaRow[] = [...base, ...combos];
export type { KanaRow };
